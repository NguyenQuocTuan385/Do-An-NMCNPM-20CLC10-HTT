...
export const newProduct = (productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`/api/v1/admin/product/new`, convertFormDataToJson(productData), config)
...
export const newReview = (reviewData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/api/v1/review`, convertFormDataToJson(reviewData), config)
...
export const updateProduct = (id, productData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/api/v1/admin/product/${id}`, convertFormDataToJson(productData), config)
