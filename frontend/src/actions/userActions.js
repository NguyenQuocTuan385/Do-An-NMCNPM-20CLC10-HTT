...
export const updateUser = (id, userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/api/v1/admin/user/${id}`, convertFormDataToJson(userData), config)
...
export const resetPassword = (token, passwords) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/api/v1/password/reset/${token}`, convertFormDataToJson(passwords), config)
