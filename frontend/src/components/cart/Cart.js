...
const Cart = () => {
    ...
    return (
        <Fragment>
            ...
            {cartItems.length === 0 ? <h2 className="mt-5">Giỏ hàng của bạn trống</h2> : (
                <Fragment>
                    <h2 class="mt-5">Giỏ hàng của bạn: <b>{cartItems.length} mặt hàng</b></h2>
                                    ...
                                    <div class="cart-item">
                                        <div class="row">
                                            ...
                                            <div class="col-4 col-lg-2 mt-4 mt-lg-0">
                                                <p id="card_item_price">{formatMoney(item.price)}₫</p>
                                            </div>
                                            ...
                                            <div class="col-4 col-lg-3 mt-4 mt-lg-0">
                                                <div class="stockCounter d-inline">
                                                    ...
                                                    <input type="number" class="form-control count d-inline"
                                                        value={item.quantity} readOnly />

                                                    <span class="btn btn-primary plus"
